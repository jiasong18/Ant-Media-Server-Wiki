...
We provide WebRTC Native Android SDK to [Ant Media Server Enterprise](https://antmedia.io) users for free. Please [keep in touch]( contact@antmedia.io) for getting WebRTC Native Android SDK. As a result, download the SDK and open it to a directory that we will import it to Android App Project
